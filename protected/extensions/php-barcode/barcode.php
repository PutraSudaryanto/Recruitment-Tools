...
class barcode 
{
	public static function Barcodegenerator($text=0, $path, $size=20, $orientation='horizontal', $code_type='code128', $quality=0) 
	{
		/**
		 ...
		 * $code_type = code128, code128b, code128a, code39, code25, codabar
		 */ 
		$code_string = "";
