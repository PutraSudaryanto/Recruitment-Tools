...
class RecruitmentSessions extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'session_info' => Yii::t('attribute', 'Session Info'),
			'session_code' => Yii::t('attribute', 'Session Code'),
			'session_date' => Yii::t('attribute', 'Session Date'),
			'session_time_start' => Yii::t('attribute', 'Time Start'),
			'session_time_finish' => Yii::t('attribute', 'Time Finish'),
			'blasting_subject' => Yii::t('attribute', 'Blasting Subject'),
			'blasting_status' => Yii::t('attribute', 'Blasting'),
			'blasting_date' => Yii::t('attribute', 'Blasting Date'),
			'blasting_id' => Yii::t('attribute', 'Blasting'),
			'documents' => Yii::t('attribute', 'Documents'),
			'document_date' => Yii::t('attribute', 'Documents Date'),
			'document_id' => Yii::t('attribute', 'Documents'),
			'creation_date' => Yii::t('attribute', 'Creation Date'),
			'creation_id' => Yii::t('attribute', 'Creation'),
			'modified_date' => Yii::t('attribute', 'Modified Date'),
			'modified_id' => Yii::t('attribute', 'Modified'),
			'pageItem' => Yii::t('attribute', 'Page Item'),
