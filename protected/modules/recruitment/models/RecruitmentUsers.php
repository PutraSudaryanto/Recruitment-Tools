...
class RecruitmentUsers extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'displayname' => Yii::t('attribute', 'Display Name'),
			'photos' => Yii::t('attribute', 'Photos'),
			'major' => Yii::t('attribute', 'Major'),
			'password_temporary' => Yii::t('attribute', 'Password Temporary'),
			...
			'oldPhoto' => Yii::t('attribute', 'Old Photo',
