...
class Recruitments extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'event_desc' => Yii::t('attribute', 'Event Desc'),
			'event_type' => Yii::t('attribute', 'Event Type'),
			'event_logo' => Yii::t('attribute', 'Event Logo'),
			'start_date' => Yii::t('attribute', 'Start Date'),
			'finish_date' => Yii::t('attribute', 'Finish Date'),
			...
			'blasting_id' => Yii::t('attribute', 'Blasting Id'),
			'creation_date' => Yii::t('attribute', 'Creation Date'),
			'creation_id' => Yii::t('attribute', 'Creation'),
			'modified_date' => Yii::t('attribute', 'Modified Date'),
			'modified_id' => Yii::t('attribute', 'Modified'),
			'permanent' => Yii::t('attribute', 'Permanent'),
			'oldEventLogo' => Yii::t('attribute', 'Old Event Logo'),
