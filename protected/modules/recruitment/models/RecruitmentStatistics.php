...
class RecruitmentStatistics extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'recruitment_insert' => Yii::t('attribute', 'Recruitment Insert'),
			'recruitment_update' => Yii::t('attribute', 'Recruitment Update'),
			'recruitment_delete' => Yii::t('attribute', 'Recruitment Delete'),
			'session_insert' => Yii::t('attribute', 'Session Insert'),
			'session_update' => Yii::t('attribute', 'Session Update'),
			'session_delete' => Yii::t('attribute', 'Session Delete'),
			'register_from_public' => Yii::t('attribute', 'Register From Public'),
			'register_from_admin' => Yii::t('attribute', 'Register From Admin'),
			'user_update_info' => Yii::t('attribute', 'User Update Info'),
			'user_update_by_admin' => Yii::t('attribute', 'User Update By Admin'),
			'admin_block_user' => Yii::t('attribute', 'Admin Block User'),
			'admin_unblock_user' => Yii::t('attribute', 'Admin Unblock User'),
			'admin_drop_user' => Yii::t('attribute', 'Admin Drop User'),
			'event_user_insert' => Yii::t('attribute', 'Event User Insert'),
			'event_user_delete' => Yii::t('attribute', 'Event User Delete'),
			'session_user_insert' => Yii::t('attribute', 'Session User Insert'),
			'session_user_delete' => Yii::t('attribute', 'Session User Delete'),
		);
	}
