...
class SessionuserController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = RecruitmentSessionUser::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('RecruitmentSessionUser', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->render('/o/session_user/front_index',array(
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = 'View Recruitment Session Users';
		$this->pageDescription = '';
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/o/session_user/front_view',array(
			'model'=>$model,
		));
		/*
		$this->render('/o/session_user/admin_view',array(
			'model'=>$model,
		));
		*/
	}	
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['RecruitmentSessionUser'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'RecruitmentSessionUser success created.');
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['RecruitmentSessionUser'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'RecruitmentSessionUser success updated.');
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
	...
	public function actionHeadline($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageDescription = '';
			$this->pageMeta = '';
			$this->render('/o/session_user/admin_headline');
		}
	}
